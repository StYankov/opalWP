...
if( 'stretch_row_content_no_spaces' !== $full_width )
	$inner_container_classes[] = 'grid-padding-x';
...
if ( ! empty( $content_placement ) ) {
	$inner_container_classes[] = 'align-' . $content_placement;	
	$flex_row = true;
}
...
if( is_numeric($spacing_bottom) )
    $css_varaibles['--section-margin-bottom'] = intval($spacing_bottom) . 'px';

if( is_numeric($spacing_bottom_tablet) ) 
    $css_varaibles['--section-margin-bottom-tablet'] = intval($spacing_bottom_tablet) . 'px';

if( is_numeric($spacing_bottom_desktop) ) 
    $css_varaibles['--section-margin-bottom-desktop'] = intval($spacing_bottom_desktop) . 'px';

...
$width = str_replace( 'vc_col-xs', 'small', $width );
$width = str_replace( 'vc_col-sm', 'medium', $width );
$width = str_replace( 'vc_col-md', 'large', $width );
$width = str_replace( 'vc_col-lg', 'xlarge', $width );
...
$innerColumnClass = 'wpb_wrapper ' . esc_attr( trim( vc_shortcode_custom_css_class( $css ) ) );
